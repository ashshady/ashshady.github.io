!function (i) {
    ...
    t.prototype = {
        run: function () {
            ...
            var t = this, s = t.$aboutCard.innerHeight(), e = i(window).height() / 2 - s / 2 + s;
            ...
            var t = this, s = t.$aboutCard.innerHeight(), e = i(window).height() / 2 - s / 2 + s;
            s + 30 > i(window).height() && (e = s), t.$aboutCard.animate({top: "-=" + e + "px"}, 500, function () {
    ...
    t.prototype = {
        run: function () {
            ...
            var e = this, s = e.categories + "[data-" + e.dataCategory + "*='" + t + "']",
    ...
    t.prototype = {
        run: function () {
            ...
            this.$codeBlocks.each(function () {
                var t = o(this).find(".gutter"), s = o(this).find(".code"), e = s.width() - s.innerWidth(),
    ...
    e(document).ready(function () {
        function t() {
            var t = !0, s = null;
            480 < e(window).height() && (t = !1, s = {width: 70, height: 70}), e(".fancybox").fancybox({
                maxWidth: 900,
                maxHeight: 800,
                fitToView: !0,
                width: "50%",
                ...
                nextEffect: "none",
                padding: "0",
                helpers: {thumbs: s, overlay: {css: {overflow: "hidden", background: "rgba(0, 0, 0, 0.85)"}}},
                afterLoad: function () {
                    setTimeout(function () {
                        e(".fancybox-next > span, .fancybox-prev > span").css("visibility", "visible")
                    }, 400)
                }
            })
        }
        ...
        run: function () {
            ...
            this.$images.each(function () {
                a = n(this), t = a.parent().parent().width(), s = a.parent().parent().innerHeight(), e = a.width(), (i = a.height()) < s && (o = e / i, a.css({
                    height: s,
                    width: s * o
                }), a.parent().css({left: "-" + (s * o / 2 - t / 2) + "px"})), e = a.width(), i = a.height(), e < t && (o = i / e, a.css({
                    width: t,
                    height: t * o
                }), a.parent().css({top: "-" + (i / 2 - s / 2) + "px"})), s < i && a.parent().css({top: "-" + (i / 2 - s / 2) + "px"})
            })
        }
    ...
    t.prototype = {
        run: function () {
            ...
            var t = e(window).scrollTop(), s = this.$postFooter.offset().top;
